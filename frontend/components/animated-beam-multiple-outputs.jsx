...
const Circle = forwardRef(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-14 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] [&_svg]:size-7",
        className
      )}
    >
      {children}
...
export default function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="flex size-full w-full max-w-3xl flex-row items-stretch justify-between gap-6 px-2 md:gap-12 md:px-6">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-20 [&_svg]:size-10">
            <Icons.openai />
          </Circle>
        </div>
